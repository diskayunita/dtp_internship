    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <h4 class="card-title">
                    <i class="ti-file"></i> View Article
                </h4>
                <p class="category">Article detail</p>
            </div>
            ...
            <div class="card-content">
                ...
                <form class="form-horizontal" style="margin-top: 10px;" method="POST" action="javascript:void(0)" enctype="multipart/form-data">
                    <div class="tab-content">
                        @include('admin.article.show-field')
                    </div>
                </form>
            </div>
            ...
            <div class="card-footer">
                <div class="form-group text-center">
                        ...
                        <a href="{!! route('admin.article.edit', [$article->id]) !!}" class='btn btn-primary btn-fill btn-wd' title="edit">
