...
@section('content')
    <div class="col-md-12">
        <form class="form-horizontal" style="margin-top: 10px;" method="POST" action="{{route('admin.article.store')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="category">Compose new article</p>
                </div>
