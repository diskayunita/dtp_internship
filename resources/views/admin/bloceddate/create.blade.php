	...
	<div class="col-md-8 col-md-offset-2">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">
					<i class="ti-plus"></i> Create Blocked Date
				</h4>
				<p class="category">Create new blocked date</p>
			</div>

			<form method="post" action="{{route('admin.blokeddate.store')}}" enctype="multipart/form-data" class="form-horizontal">
				{{-- card-content --}}
