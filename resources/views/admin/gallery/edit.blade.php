...
@section('content')
    <div class="col-md-12">
        ...
        <div class="card">
            <form class="form-horizontal" style="margin-top: 10px;" method="POST" action="{{route('admin.update_gallery', $gallery)}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card-header">
                    <h4 class="card-title">
                        <i class="ti-pencil"></i> Edit Gallery
                    </h4>
                    <p class="category">Edit and Update Gallery</p>
                </div>
