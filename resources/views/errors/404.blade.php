...
<html lang="en">
    <head>
        ...
        <link href="{{url('assets/css/simple-line-icons.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{url('assets/css/socicon.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{url('assets/css/bootstrap.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{url('assets/css/bootstrap-switch.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body class=" page-404-full-page">
        <div class="row">
            <div class="col-md-12 page-404">
                <div class="number font-red-thunderbird"> 404 </div>
                <div class="details">
        ...
        <script src="{{url('assets/js/bootstrap-switch.js')}}" type="text/javascript"></script>
